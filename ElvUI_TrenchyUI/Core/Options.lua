...
function ElvUI_TrenchyUI:Configtable()
	...
	ElvUI_TrenchyUI.Options.args.wdGroup.args.wdForceClass = E.Libs.ACH:Toggle("Class Colors", "Override WarpDeplete bar colors with your custom class color.", 3, nil, nil, nil,
    function() return E.db.ElvUI_TrenchyUI.warpdeplete and E.db.ElvUI_TrenchyUI.warpdeplete.forceClassColors end,
    function(_, value) ElvUI_TrenchyUI:WarpDeplete_SetUseClassColors(value) end)
	-- OmniCD Group and Options
	...
	function() return E.db.ElvUI_TrenchyUI.omnicd.forceCCC end, function(_, value) ElvUI_TrenchyUI:OmniCD_SetUseCCC(value) end)
	ElvUI_TrenchyUI.Options.args.ocGroup.args.ocGap = E.Libs.ACH:Range("Padding X", nil, 5, { min = 0, max = 40, step = 1 }, nil, function() return E.db.ElvUI_TrenchyUI.omnicd.gapX end, function(_, value) ElvUI_TrenchyUI:OmniCD_SetGap(value) end)
