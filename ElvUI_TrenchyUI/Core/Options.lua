...
function ElvUI_TrenchyUI:Configtable()
	...
	ElvUI_TrenchyUI.Options.args.applySeasonalStyle = E.Libs.ACH:Execute("Seasonal (|cff40ff40"..E.db.ElvUI_TrenchyUI.StyleFilters.Seasonal.Version.."|r)", nil, 10, function()
		ElvUI_TrenchyUI:ApplyTrenchyStyleFiltersDB("Seasonal")
	end, nil, nil, "full")
	ElvUI_TrenchyUI.Options.args.applyCommonStyle = E.Libs.ACH:Execute("Common (|cff40ff40"..E.db.ElvUI_TrenchyUI.StyleFilters.Common.Version.."|r)", nil, 11, function()
