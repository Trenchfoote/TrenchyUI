...
function ElvUI_TrenchyUI:Configtable()
	...
	ElvUI_TrenchyUI.Options.args.applySeasonalStyle = E.Libs.ACH:Execute("Apply Seasonal Style Filters (|cff40ff40"..E.db.ElvUI_TrenchyUI.StyleFilters.Seasonal.Version.."|r)", nil, 10, function()
		ElvUI_TrenchyUI:ApplyTrenchyStyleFiltersDB("Seasonal")
	end, nil, nil, "full")
	ElvUI_TrenchyUI.Options.args.applyCommonStyle = E.Libs.ACH:Execute("Apply Common Style Filters (|cff40ff40"..E.db.ElvUI_TrenchyUI.StyleFilters.Common.Version.."|r)", nil, 11, function()
	...
	ElvUI_TrenchyUI.Options.args.applyBigWigsOnlyPlates = E.Libs.ACH:Execute("Apply BigWigs OnlyPlates Profile", nil, 13, function()
		ElvUI_TrenchyUI:BigWigs("OnlyPlates")
	end, nil, nil, "full")
	ElvUI_TrenchyUI.Options.args.applyBigWigsUnnamed = E.Libs.ACH:Execute("Apply BigWigs Unnamed Profile", nil, 13, function()
	...
	ElvUI_TrenchyUI.Options.args.applyOmniCDOnlyPlates = E.Libs.ACH:Execute("Apply OmniCD OnlyPlates Profile", nil, 15, function()
		ElvUI_TrenchyUI:OmniCD("OnlyPlates")
	end, nil, nil, "full")
	ElvUI_TrenchyUI.Options.args.applyOmniCDUnnamed = E.Libs.ACH:Execute("Apply OmniCD Unnamed Profile", nil, 15, function()
