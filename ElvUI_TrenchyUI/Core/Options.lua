...
function ElvUI_TrenchyUI:Configtable()
	...
	ElvUI_TrenchyUI.Options.args.applyOmniCD = E.Libs.ACH:Execute("Apply OmniCD OnlyPlates Profile", nil, 15, function()
		ElvUI_TrenchyUI:OmniCD("OnlyPlates")
	end, nil, nil, "full")
	ElvUI_TrenchyUI.Options.args.applyOmniCD = E.Libs.ACH:Execute("Apply OmniCD Unnamed Profile", nil, 15, function()
